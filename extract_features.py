...
parser.add_argument("-train_path", type=str, default='G:/CesareDou/ModelNet40_images_2048_224_6views/*/train')
parser.add_argument("-val_path", type=str, default="G:/CesareDou/ModelNet40_images_2048_224_6views/*/test")
...
gallery_dataset = MultiviewImgDataset(args.train_path, scale_aug=False, rot_aug=False, test_mode=True,
                                      shuffle=False, num_views=args.num_views)
gallery_loader = torch.utils.data.DataLoader(gallery_dataset, batch_size=args.batchSize, shuffle=False, num_workers=0)
query_dataset = MultiviewImgDataset(args.val_path, scale_aug=False, rot_aug=False, test_mode=True,
                                    shuffle=False, num_views=args.num_views)
query_loader = torch.utils.data.DataLoader(query_dataset, batch_size=args.batchSize, shuffle=False, num_workers=0)
...
gallery_features_list, gallery_labels_list = extract_features(cnet_2, gallery_loader)
sio.savemat(log_dir + '/gallery.mat', {'features': gallery_features_list, 'labels': gallery_labels_list})
